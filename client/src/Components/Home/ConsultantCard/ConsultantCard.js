        ...
        return (
            ...
            <div className="consultant-card">
                {this.props.info.picture ?
                    <div className="consultant-img-wrapper"  style={{top: this.state.hover ? "-5px" : "0"}} onClick={ () => {this.props.closeScreen();setTimeout( () => this.props.history.push('/chat/' + this.props.info.name), 2500)}}>
